...
window.I18N = (() => {
  ...
  const dict = {
    ...
    ctrl_animation: { 'zh-CN': '动画效果', 'zh-TW': '動畫效果', en: 'Animations', ja: 'アニメーション' },
    ...
    ctrl_history: { 'zh-CN': '历史记录', 'zh-TW': '歷史記錄', en: 'History', ja: '履歴' },
    ctrl_favorites: { 'zh-CN': '收藏夹', 'zh-TW': '收藏夾', en: 'Favorites', ja: 'お気に入り' },
